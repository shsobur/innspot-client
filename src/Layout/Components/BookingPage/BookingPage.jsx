    ...
    axiosSecure
      ...
      .then((res) => {
        ...
        if (res.data.acknowledged) {
          ...
          axiosSecure
            .patch(`/rooms/${roomInfo._id}`, roomAvailability)
            .then((res) => {
              ...
              <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="flex justify-end mt-6">
                    <input
                      className="px-8 cursor-pointer py-2.5 leading-5 text-white transition-colors duration-300 transform bg-[#7c6a46] rounded-md hover:bg-[#615236] focus:outline-none focus:bg-gray-600"
                      type="submit"
                      value="Conform"
                    ></input>
                  </div>
