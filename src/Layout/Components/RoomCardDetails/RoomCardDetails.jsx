            ...
            <div className="main_details_container">
              ...
              <div className="details_image_and_info_section_container">
                ...
                <div className="details_left_side_image_container">
                  ...
                  >
                    {
                      roomInfo.images.map(img => <SwiperSlide key={img}>
                  ...
                  <div className="offer_container">
                      ...
                      <div className="offer_inner_container">
                        ...
                        <p>
                          {
                            roomInfo.offers ? <p> {roomInfo.offers} </p> : <p> Not Available Now! </p>
                          }
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="details_right_side_inner_left_container">
                    ...
                    <div className="details_inner_left_outer_container">
                      <div className="details_inner_left_container">
                        <h2>{roomInfo.name}</h2>
                        <p><span>Room Size:</span>  {roomInfo.roomSize}</p>
                        <p><span>Max Gest:</span>  {roomInfo.maxGuests}</p>
                        <p><span>Room Number:</span>  {roomInfo.roomNumber}</p>
                        <p><span>Ctegory:</span> {roomInfo.category}</p>
                      </div>
                      ...
                      <div className="details_facilities_container">
                        ...
                        <div>
                          {
                            roomInfo.amenities.map(amenitie => <p key={amenitie}>{amenitie}</p>)
                          }
                          {/* <p>Wi-Fi</p>
                          <p>Private butler</p>
                          <p>Jacuzzi</p>
                    ...
                    <div className="booking_container">
                      <h2>Start Booking</h2>
                      <h1>${roomInfo.pricePerNight} <span>par Night</span></h1>
